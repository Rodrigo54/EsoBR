local MAJOR, MINOR = "LibAsync", 1.8
local async, oldminor = LibStub and LibStub:NewLibrary(MAJOR, MINOR) or { }
...
local frameTimeTarget = GetCVar("VSYNC") == "1" and 0.014 or(tonumber(GetCVar("MinFrameTime.2")))
...
function async.Scheduler()
	...
	local runTime, cpuLoad = start, GetGameTimeSeconds() - start
...
local function register()
	...
	em:RegisterForUpdate(identifier, 0, function() return async.Scheduler() end)
end
